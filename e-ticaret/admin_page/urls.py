...
urlpatterns = [
    ...
    path("urunduzenleme/<int:id>",views.urun_duzenleme_yap,name="urun_duzenleme_yap"),
    path("urunduzenlemefitre/<int:id>",views.urun_filre_ve_resim_duzenle,name="urun_filre_ve_resim_duzenle"),
